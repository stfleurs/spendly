...
_AppTransaction _$AppTransactionFromJson(Map<String, dynamic> json) =>
    _AppTransaction(
      ...
      amountInBaseCurrency: (json['amountInBaseCurrency'] as num).toInt(),
      baseCurrency: json['baseCurrency'] as String,
      exchangeRate: (json['exchangeRate'] as num).toDouble(),
      rateScale: (json['rateScale'] as num?)?.toInt() ?? 1000000,
      scaledRate: (json['scaledRate'] as num).toInt(),
      rateSource: json['rateSource'] as String? ?? 'manual',
      rateBaseCurrency: json['rateBaseCurrency'] as String?,
      rateQuoteCurrency: json['rateQuoteCurrency'] as String?,
